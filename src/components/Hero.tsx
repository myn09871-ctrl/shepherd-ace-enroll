      ...
      <div className="container mx-auto px-4 pt-24 pb-16 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-primary-foreground space-y-8">
            ...
            {/* Heading */}
            <h1 className="font-heading text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight animate-fade-up animation-delay-100">
              Nurturing{" "}
            ...
            {/* Motto */}
            <p className="text-lg sm:text-xl text-primary-foreground/90 italic font-heading animate-fade-up animation-delay-200">
              "In God We Trust"
            </p>

            {/* Description */}
            <p className="text-lg text-primary-foreground/80 max-w-xl animate-fade-up animation-delay-300">
            ...
            {/* Stats */}
            <div className="grid grid-cols-3 gap-6 pt-8 border-t border-primary-foreground/20 animate-fade-up animation-delay-500">
              <div>
                <div className="flex items-center gap-2 mb-1">
                  <Award className="h-5 w-5 text-accent" />
                  <span className="font-heading text-3xl font-bold">100%</span>
                </div>
                <p className="text-sm text-primary-foreground/70">BECE Pass Rate</p>
              </div>
              <div>
                <div className="flex items-center gap-2 mb-1">
